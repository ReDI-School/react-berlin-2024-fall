import "../lessons/Lesson13useEffect.css";
  ...
  return (
    <div className={"card"}>
      ...
      <div className={"content"}>
        <h4>
          <b>country: {country.name.common}</b>
        </h4>
        <h4>
          <b> capital: {/* // A bit of error handling below. "capital" is an array, but there are some countries without the property "capital", so our code below do not break neither if capital property doesn't exist, nor if, by any chance,  there is no value for that property */}
